...
module Keyboards
  module KeyboardHelpers
    ...
    def inline_keyboard(*args, **options)
      self.class.inline_keyboard(*args, **options)
    end
    ...
    module ClassMethods
      def inline_keyboard(*buttons, **options)
      ...
      def reply_keyboard(*buttons, **options)
